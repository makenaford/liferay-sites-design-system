...
const preview: Preview = {
  parameters: {
    ...
    options: {
      storySort: {
        order: ['Overview', ['Introduction', 'Design Tokens', 'Icons'], 'Components', 'Templates', ['Sections', 'Page Templates'], 'Built Pages'],
      },
    },
  },
  ...
  /** Dark is the mode the Figma library is drawn in. */
